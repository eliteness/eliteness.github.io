  ...
  "categories": [
    {
      ...
      "tiles": [
        ...
        {
          "name": "ABcDeFx.",
          "description": "<b>A</b> <b>B</b>lock<b>c</b>hain <b>D</b>ecentralized <b>E</b>xchange & <b>F</b>orE<b>x</b> is a user-friendly StableSwap AMM DEX.",
        ...
        {
          "name": "Dexchelon",
          "description": "On-chain DEX Aggregator with JIT liquidity procurement and PMM pools.",
        ...
        },
        {
          ...
          "description": "Solidly Extended adds support for Fee-on-Transfer tokens, Rebase, reflection & other exotic assets to Native Solidly.",
        ...
        },
        {
          ...
          "description": "Alternative UI Mirror for the Equalizer.exchange Liquidity Hub on Fantom.",
        ...
        },
        {
          ...
          "description": "Alternative UI Mirror for the Equity.Equalizer.exchange Oracle-driven DEX on Fantom.",
        ...
        },
        {
          ...
          "description": "Alternative UI Mirror for the Base.Equalizer.exchange (SCALE) Liquidity Hub on Base.",
          "url": "https://equal.eliteness.network",
    ...
    },
    {
      ...
      "tiles": [
        {
          "name": "ELMA",
          "description": "<b>Elite Lending Market Aggregator</b> can Turbocharge your Lending Market Yields by separating your Principal Tokens (PT) from its Lending Yield (virtual YT) and tapping into the Earnings Flywheel.",
    ...
    },
    {
      ...
      "tiles": [
        ...
        {
          "name": "Fertilizer (Base)",
          "description": "Automatic Liquidity Management (ALM) Protocol with Advanced Dynamic Liquidity-Shape Management on Base.",
        ...
        },
        {
          ...
          "description": "Wrapper on Morphex.Trade's MLP for magnified Real Yield and Automated Self-Bribing Meta-pools!",
        ...
        {
          "name": "XELITE",
          "description": "Interest-bearing and Fractionalized ELITE compatible with tax-free DeFi applications.",
        ...
        {
          "name": "Kompound",
          "description": "First ever Immutable & Permissionless Yield Compounder & Optimization protocol.",
        ...
        {
          "name": "Yield State",
          "description": "<i>Now Deprecated.</i> Yield Farming platform of ELITE liquidity providers at Sushi & Spooky!",
    ...
    },
    {
      ...
      "tiles": [
        {
          "name": "MCLB Lockless mFTM",
          "description": "Liquid-Staking Token (LST) for FTM Locked on Millenium Club Validator Nodes 37 & 63 on Fantom Opera Blockchain.",
        ...
        },
        {
          ...
          "description": "Liquid-Staking Token (LST) for KAVA Locked on our Validator Nodes for Cosmos+EVM Kava Network Mainnet.",
        ...
        {
          "name": "Lockless SWECH",
          "description": "Liquid-Staking Token (LST) for ECH Locked on our Echelon Validator Nodes.",
    ...
    {
      "title": "Financial NFTs & veNFTs",
      "tiles": [
        {
          "name": "eLOCKS",
          "description": "Revolutionizing Protocol-owned Liquidity with Tokenizing Gauged Principal & Yields using On-chain Fully Dynamic Financial NFTs.",
        ...
        {
          "name": "VeNFT A.M.M.",
          "description": "veN AMM is a DEX for trading EQUAL veNFTs permissionlessly, 24x7 against Fungible + Non-fungible Hybrid Liquidity pool on Fantom.",
        ...
        },
        {
          ...
          "description": "veLiquidity is a modern veN AMM implementation for trading SCALE veNFTs permissionlessly, 24x7 against Fungible + Non-fungible Hybrid Liquidity pool on Base.",
    ...
    },
    {
      ...
      "tiles": [
        {
          "name": "DeGam",
          "description": "The first ever Casino on Fantom, born in 2021! First Telegram-to-Blockchain GameFi Dapp on Fantom.",
        ...
        {
          "name": "Kucino Casino",
          "description": "12+ Gaming Titles for immersive GambleFi experience on the Kucoin Chain!",
    ...
    {
      "title": "Comparative Analytics and more",
      "tiles": [
        {
